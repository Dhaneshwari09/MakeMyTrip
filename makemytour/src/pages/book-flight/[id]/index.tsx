...
const BookFlightPage = () => {
  ...
  //----Booking Dialog Details Open 
  const BookingContent = () => (
    <DialogContent className="sm:max-w-[600px] text-black bg-white">
      <DialogHeader>
        <DialogTitle className="text-2xl text-black font-bold flex items-center">
      ...
      <div className="grid gap-6 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="flightName" className="flex text-black items-center">
              <Plane className="w-4 h-4  mr-2" />
               Flight Name
            </Label>
            <Input id="flightName" className="text-black" value={flight?.flightName} readOnly />
          </div>
          <div className="space-y-2">
            <Label htmlFor="from" className="flex text-black items-center">
              <MapPin className="w-4 h-4 text-black mr-2" />
              From
            </Label>
            <Input id="from" className="text-black" value={flight?.from} readOnly />
          </div>
          <div className="space-y-2">
            <Label htmlFor="to" className="flex text-black items-center">
              <MapPin className="w-4 text-black -4 mr-2" />
              To
            </Label>
            <Input id="to" value={flight?.to} className="text-black" readOnly />
          </div>
          <div className="space-y-2">
            <Label htmlFor="departureTime" className="flex text-black items-center">
              <Calendar className="w-4 text-black h-4 mr-2" />
              Departure Time
            </Label>
            <Input
              id="departureTime"
          ...
          <div className="space-y-2">
            <Label htmlFor="arrivalTime" className="flex text-black items-center">
              <Clock className="w-4 text-black h-4 mr-2" />
              Arrival Time
            </Label>
            <Input
              id="arrivalTime"
          ...
          <div className="space-y-2">
            <Label htmlFor="quantity" className="flex text-black items-center">
              <Ticket className="w-4 h-4 text-black mr-2" />
              Number of Tickets
            </Label>
            <Input
              id="quantity"
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-600">{flight?.flightName}</span>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div>
                  <div className="flex items-center flex-wrap gap-4 mb-2">
                    <h2 className="text-lg font-bold text-black flex items-center">
                      ...
                      <ArrowRight className="w-5 text-black h-5 mx-2" />
                      <span>{flight?.to}</span>
                    </h2>
                  ...
                  <div className="flex text-black items-center text-sm text-gray-600">
                    <Calendar className="w-4 text-black h-4 mr-2" />
              ...
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  <div className="text-black font-semibold">{flight.flightName}</div>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className=" text-black font-semibold">BLR-DEL</span>
                  </div>
                  <div className="font-bold text-black text-lg">₹ 4,300</div>
                </div>
                ...
                <div className="bg-[#FFF8E7] p-6 rounded-xl">
                  ...
                  <div className="relative text-black mb-4">
                    <input
                      ...
                      className="w-full px-4 text-black py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                    />
                  </div>
