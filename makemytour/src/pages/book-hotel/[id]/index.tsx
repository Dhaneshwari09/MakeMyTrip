      ...
      <div className="grid gap-6 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="hotelName" className="flex text-black items-center">
              <MapPin className="w-4 text-black h-4 mr-2" />
              Hotel Name
            </Label>
            <Input id="hotelName" className="text-black" value={hotel.hotelName} readOnly />
          </div>

          {/* Location */}
          <div className="space-y-2">
            <Label htmlFor="location" className="flex text-black items-center">
              <MapPin className="w-4 text-black h-4 mr-2" />
              Location
            </Label>
            <Input id="location" className="text-black" value={hotel.location} readOnly />
          </div>
          {/* Price Per Night */}
          <div className="space-y-2">
            <Label htmlFor="pricePerNight" className="flex text-black items-center">
              <Ticket className="w-4 text-black h-4 mr-2" />
              Price Per Night
            </Label>
            <Input
              id="pricePerNight"
          ...
          {/* Available Rooms */}
          <div className="space-y-2">
            <Label htmlFor="availableRooms" className="flex text-black items-center">
              <Ticket className="w-4 h-4 text-black mr-2" />
              Available Rooms
            </Label>
            <Input id="availableRooms"   className="text-black" value={hotel.availableRooms} readOnly />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="col-span-2 text-black relative group cursor-pointer">
                <img
              ...
              <div className="space-y-4">
                ...
                <div className="relative group text-black cursor-pointer">
                  <img
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex items-center justify-between text-2xl font-bold">
                  <span className="text-black">₹ {grandTotal}</span>
