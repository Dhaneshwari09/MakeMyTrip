  ...
  return (
    ...
    >
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-xl shadow-lg mx-auto text-gray-500 max-w-5xl p-6">
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          <input
            ...
            value={value}
            onChange={onChange}
            className="font-semibold w-full bg-white text-gray-500 outline-none"
          />
          {subtitle && (
